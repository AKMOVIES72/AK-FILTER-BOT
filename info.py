...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1003721632210').split()]  # For Multiple Id Use One Space Between Each.
